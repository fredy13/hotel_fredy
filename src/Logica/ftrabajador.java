    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                registro[9] = rs.getNString("sueldo");
                registro[10] = rs.getNString("acceso");
                registro[11] = rs.getNString("login");
                registro[12] = rs.getNString("password");
                registro[13] = rs.getNString("estado");
     ...
     public DefaultTableModel login(String login,String password) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                registro[4] = rs.getNString("acceso");
                registro[5] = rs.getNString("login");
                registro[6] = rs.getNString("password");
                registro[7] = rs.getNString("estado");
